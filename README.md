<div style="display: flex; align-items: center;">
  ...
  <div style="margin-right: 30px;">
    <img src="SB.jpg" alt="Profile Picture" width="140" style="border-radius: 50%;">
  </div>
  ...
  <div>
    <ul style="list-style: none; padding: 0;">
      ...
      <li style="margin-bottom: 8px;"><a href="https://x.com/SumantaBarman" style="margin-left: 300px;"><img src="Xlogo.png" alt="X" width="30"></a></li>
...
margin-right: 10px;
  ...
  #sticky-menu nav a.home::before {
      ...
      background-image: url("home_icon.png"); /* Replace with your logo file name */
...
<div class="collapse">
  <span>&#9658;</span> <b>May 25, 2025: Pre-print Announcement</b>
</div>
...
<div class="collapse">
  <span>&#9658;</span> <b>November 4, 2024: My new position</b> 
  </div>
<div class="collapse-content">
  <div style="text-align: justify;">
    <ul>
...
<div class="projects"><b>Recombinant monoclonal antibody technology:</b>
        <ul>
...
<body>
  ...
  <strong>Containerization:</strong> Docker, Singularity<br>
...
<div class="collapse-content">
  ...
  <ol>
    ...
    <br>
    <li>
      <strong><a href="https://www.thelancet.com/journals/ebiom/article/PIIS2352-3964(24)00266-4/fulltext" target="_blank">Identification of disease phenotypes in acetylcholine receptor-antibody myasthenia gravis using proteomics-based consensus clustering</a></strong><br>
      <em>Authors:</em>
      <div style="text-align: justify;">
...
## <b>Interests</b>
  ...
  <div style="display: flex; justify-content: center; align-items: center;">
    <img src="interests.jpg" alt="hobbies image" style="max-width: 40%; height: auto; margin-right: 10px;">
  </div>
   <br> 
...
<div class="collapse-content" id="blog1-content">
  <div class="blog-justify">
    ...
    <p> Reading time: approximately 4 minutes (To read in Bangla, please scroll down)
    </p>
    ...
    <h4>গর্ভাবস্থায়</h4>
    <ul>
      <li>গর্ভধারণের দুই সপ্তাহ পর মস্তিষ্ক গঠিত হতে শুরু করে, যা নিউরাল প্লেট থেকে নিউরাল টিউবে পরিণত হয় এবং স্নায়ুতন্ত্র তৈরি হয়।</li>
      <li>দ্রুত নিউরন উৎপন্ন হয়, নবজাতকের মস্তিষ্কে প্রায় ১০০ বিলিয়ন নিউরন থাকে-যা একজন প্রাপ্তবয়স্কের থেকেও বেশি। এই অতিরিক্ত নিউরন পরবর্তীতে ছাঁটাই (pruning) হয়।</li>
    </ul>
    <h4>শৈশব</h4>
    <ul>
    ...
    <ul>
      ...
      <li>সাধারণত ৩০ বছর বয়সে মস্তিষ্ক পুরোপুরি পরিপক্ক হয়, এবং হোয়াইট ম্যাটার ৪০ বছর বয়সে সর্বাধিক হয়।</li>
    </ul>
    <h4>মধ্যবয়স</h4>
    <ul>
...
<script>
document.getElementById('blog1-toggle').onclick = function() {
...
<div class="collapse-content" id="blog4-content">
  <div class="blog-justify">
    ...
    <hr style="margin:40px 0 30px 0;">
    <h3 style="color:#1a237e;">বাংলা অনুবাদ</h3>
    <h4>গাট চেক: আপনার খাদ্যাভ্যাস কীভাবে আপনার অন্ত্রের জীবাণুগুলোকে প্রভাবিত করে</h4>
    <p>
    ...
    <ul>
      <li>উদ্ভিদজাত খাবারের বৈচিত্র্য বাড়ান: সপ্তাহে নানা রঙের ফল, সবজি, শস্য ও ডাল খান</li>
    ...
    <ul>
    <strong>"আরও বেশি উদ্ভিদজাত খাবার খেয়ে আপনার সুখ ও স্বাস্থ্য বাড়িয়ে তুলুন"</strong>
    </ul>
...
<a href="https://x.com/SumantaBarman"><img src="Xlogo.png" alt="X" width="30"></a>
