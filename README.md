...
<div style="text-align: justify;">
    <ul>
        ...
        <li><strong>Data Analysis and Visualization:</strong></li>
          <li>Single cell sequencing data analysis: Cell Ranger, STAR, SciPy, Seurat, Scanpy, SCVItools, Monocle, Harmony, Dandelion, scRepertoire, NAIR, Propeller, Enclone, GLIPH, Immunearch, Immcantation, Tcrdist3, Loupe Browser, Loupe V(D)J Browser, DESeq2, limma</li>  
          <li>Bulk seq analysis: MiXCR, STAR, VDJtools, Immunearch, Immcantation<li> 
          <li>Others: R Markdown, Pandas, NumPy, Ggplot2, Plotly, Matplotlib, UMAP, t-SNE, TCRex, ViClod etc.</li>
